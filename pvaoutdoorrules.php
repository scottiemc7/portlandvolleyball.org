...
<ul>
  ...
  <li><u>Hard driven</u> hit can be set (official's judgement) but off-speed hit cannot be set (no finger action until 2nd or 3rd contact)</li>
  <li>No directional blocks (no breaking wrist, either down or to a side)</li>
  ...
  <li>2 players contacting the ball at the same time is considered 2 hits and either player can then take it over the net unless referee clearly sees only one person contacting the ball</li>
  ...
  <li>Reminder, no alcohol permitted before or during play</li>
  <li>Minimum number of players required to play - 3</li>
</ul>
</p>
<p>
...
<p>
<i>Additional Rules for Sand</i><br>
<ul>
  <li>Same as outdoor rules except teams playing with 5 or 6 players must use the following indoor rules:
    <ul>
      <li>Players must line up alternating male and female and rotate accordingly</li>
      <li>A woman must touch the ball if there is more than one contact</li>
    </ul>
  </li>
</ul>
