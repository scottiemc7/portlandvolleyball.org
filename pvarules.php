...
<div id="content" class="container">
  ...
  <ul>
    <li>League levels only apply to a given night<br />
      <em>(e.g. on Monday, the "BB" league has a higher skill level than the "B" league)</em></li>
      <br />
      <li>There is no correlation between leagues on different nights<br />
        <em>(e.g. the Thursday "B" league may have a higher skill level than the Wednesday "A" league)</em>
      </li>
    </ul>
  </p>
