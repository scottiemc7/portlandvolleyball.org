...
<p>
<i>LEAGUE LEVELS: (ordered from highest to lowest skills)</i>
...
<ul>
<li>League levels only apply to a given night<br />
    <i>(e.g. on Monday, the "BB" league has a higher skill level than the "B" league)</i></li>
<br />
<li>There is no correlation between leagues on different nights<br />
    <i>(e.g. the Thursday "B" league may have a higher skill level than the Wednesday "A" league)</i></li>
</ul>
</p>
...
<li>Head to head record (if two teams are tied)</li>
<li>Points differential in all sets involving the tied teams</li>
<li>Points allowed in sets involving the tied teams in sets against each other</li>
<li>Coin toss</li>
</ul>
</p>
...
<li>Two points for winning the most sets in a match</li>
</ul>
</p>
